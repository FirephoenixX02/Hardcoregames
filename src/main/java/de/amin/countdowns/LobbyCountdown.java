...
public class LobbyCountdown extends Countdown {
    ...
    public void startIdle() {
        String prefix = SpeedHG.INSTANCE.PREFIX;
        isIdling = true;
        idleID = Bukkit.getScheduler().scheduleSyncRepeatingTask(SpeedHG.INSTANCE, new Runnable() {
            @Override
            public void run() {
                int requiredPlayers = LobbyState.MIN_PLAYERS - SpeedHG.INSTANCE.getPlayers().size();
